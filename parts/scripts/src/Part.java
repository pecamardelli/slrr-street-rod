...
public class Part extends GameType
{
	...
	final static int SAVEFILEVERSION_PART = 2;
	static int save_version = SAVEFILEVERSION_PART;
	...
	static float latestAccuracy = 0.015; // for adjustable position scripts
