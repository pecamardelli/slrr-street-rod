...
public class Prime_FR_McPherson_strut extends AdjustableSuspension
{
	public Prime_FR_McPherson_strut ( int id )
	{
		super( id );

		name = "Prime DLH 500 front right McPherson strut";
