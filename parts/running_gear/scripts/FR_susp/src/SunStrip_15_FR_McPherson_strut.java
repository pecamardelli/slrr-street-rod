...
public class SunStrip_15_FR_McPherson_strut extends AdjustableSuspension
{
	public SunStrip_15_FR_McPherson_strut ( int id )
	{
		super( id );

		name = "Duhen SunStrip 1.5 DVC front right McPherson strut";

		value = tHUF2USD(48.0);
		brand_new_prestige_value = 33.0;
