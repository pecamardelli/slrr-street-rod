...
public class MC_GTLE_FR_McPherson_strut extends AdjustableSuspension
{
	public MC_GTLE_FR_McPherson_strut ( int id )
	{
		super( id );

		name = "MC GTLE front right McPherson strut";

		value = tHUF2USD(103.0);
		brand_new_prestige_value = 51.0;
