...
public class Focer_WRC_FR_McPherson_strut extends AdjustableSuspension
{
	public Focer_WRC_FR_McPherson_strut ( int id )
	{
		super( id );

		name = "Shimutshibu Focer WRC front right McPherson strut";

		value = tHUF2USD(165.0);
