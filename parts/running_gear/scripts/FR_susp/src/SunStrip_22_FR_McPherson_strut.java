...
public class SunStrip_22_FR_McPherson_strut extends AdjustableSuspension
{
	public SunStrip_22_FR_McPherson_strut ( int id )
	{
		super( id );

		name = "Duhen SunStrip 2.2 DVC front right McPherson strut";

		value = tHUF2USD(71.0);
		brand_new_prestige_value = 41.0;
