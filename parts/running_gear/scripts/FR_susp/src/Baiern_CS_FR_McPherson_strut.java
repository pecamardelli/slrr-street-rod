...
public class Baiern_CS_FR_McPherson_strut extends AdjustableSuspension
{
	public Baiern_CS_FR_McPherson_strut ( int id )
	{
		super( id );

		name = "Baiern CoupeSport 2.5 front right McPherson strut";
