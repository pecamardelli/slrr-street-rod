...
public class Nonus_GT2_FR_McPherson_strut extends AdjustableSuspension
{
	public Nonus_GT2_FR_McPherson_strut ( int id )
	{
		super( id );

		name = "Emer Motorsport Nonus GT2 front right McPherson strut";
