...
public class SuperDuty_750_FR_McPherson_strut extends AdjustableSuspension
{
	public SuperDuty_750_FR_McPherson_strut ( int id )
	{
		super( id );

		name = "Hauler's SuperDuty Extra 750 front right McPherson strut";

		value = tHUF2USD(99.0);
		brand_new_prestige_value = 72.0;
