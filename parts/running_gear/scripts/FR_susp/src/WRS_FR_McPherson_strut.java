...
public class WRS_FR_McPherson_strut extends AdjustableSuspension
{
	public WRS_FR_McPherson_strut ( int id )
	{
		super( id );

		name = "Ishima Enula WR SuperTurizmo front right McPherson strut";

		value = tHUF2USD(185.0);
