...
public class Einvagen_GTK_FR_McPherson_strut extends AdjustableSuspension
{
	public Einvagen_GTK_FR_McPherson_strut ( int id )
	{
		super( id );

		name = "Einvagen 110 GTK front right McPherson strut";
