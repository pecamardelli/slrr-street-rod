...
public class Baiern_GT_FR_McPherson_strut extends AdjustableSuspension
{
	public Baiern_GT_FR_McPherson_strut ( int id )
	{
		super( id );

		name = "Baiern CoupeSport GT III front right McPherson strut";

		value = tHUF2USD(170.0);
