...
public class Focer_300_FR_McPherson_strut extends AdjustableSuspension
{
	public Focer_300_FR_McPherson_strut ( int id )
	{
		super( id );

		name = "Shimutshibu Focer 300 front right McPherson strut";
