...
public class MC_GT_FR_McPherson_strut extends AdjustableSuspension
{
	public MC_GT_FR_McPherson_strut ( int id )
	{
		super( id );

		name = "MC GT front right McPherson strut";

		value = tHUF2USD(103.0);
		brand_new_prestige_value = 56.0;
