...
public class Einvagen_GTA_FR_McPherson_strut extends AdjustableSuspension
{
	public Einvagen_GTA_FR_McPherson_strut ( int id )
	{
		super( id );

		name = "Einvagen 140 GTA front right McPherson strut";

		value = tHUF2USD(110.0);
		brand_new_prestige_value = 41.5;
