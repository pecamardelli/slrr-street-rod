...
public class SunStrip_20_FR_McPherson_strut extends AdjustableSuspension
{
	public SunStrip_20_FR_McPherson_strut ( int id )
	{
		super( id );

		name = "Duhen Racing SunStrip 2.0 CDVC front right McPherson strut";

		value = tHUF2USD(125.0);
		brand_new_prestige_value = 63.0;
