...
public class Einvagen_GT_FR_McPherson_strut extends AdjustableSuspension
{
	public Einvagen_GT_FR_McPherson_strut ( int id )
	{
		super( id );

		name = "Einvagen 110 GT front right McPherson strut";
