...
public class SuperDuty_750_FL_McPherson_strut extends AdjustableSuspension
{
	public SuperDuty_750_FL_McPherson_strut ( int id )
	{
		super( id );

		name = "Hauler's SuperDuty Extra 750 front left McPherson strut";
