...
public class SunStrip_15_FL_McPherson_strut extends AdjustableSuspension
{
	public SunStrip_15_FL_McPherson_strut ( int id )
	{
		super( id );

		name = "Duhen SunStrip 1.5 DVC front left McPherson strut";
