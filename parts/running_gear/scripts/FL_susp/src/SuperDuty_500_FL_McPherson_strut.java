...
public class SuperDuty_500_FL_McPherson_strut extends AdjustableSuspension
{
	public SuperDuty_500_FL_McPherson_strut ( int id )
	{
		super( id );

		name = "Hauler's SuperDuty 500 front left McPherson strut";
