...
public class SunStrip_22_FL_McPherson_strut extends AdjustableSuspension
{
	public SunStrip_22_FL_McPherson_strut ( int id )
	{
		super( id );

		name = "Duhen SunStrip 2.2 DVC front left McPherson strut";
