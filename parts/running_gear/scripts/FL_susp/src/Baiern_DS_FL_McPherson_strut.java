...
public class Baiern_DS_FL_McPherson_strut extends AdjustableSuspension
{
	public Baiern_DS_FL_McPherson_strut ( int id )
	{
		super( id );

		name = "Baiern DevilSport front left McPherson strut";
