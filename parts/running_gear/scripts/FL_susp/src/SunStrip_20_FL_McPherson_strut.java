...
public class SunStrip_20_FL_McPherson_strut extends AdjustableSuspension
{
	public SunStrip_20_FL_McPherson_strut ( int id )
	{
		super( id );

		name = "Duhen Racing SunStrip 2.0 CDVC front left McPherson strut";
