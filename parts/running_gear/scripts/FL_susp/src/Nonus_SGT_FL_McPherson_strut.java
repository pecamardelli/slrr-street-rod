...
public class Nonus_SGT_FL_McPherson_strut extends AdjustableSuspension
{
	public Nonus_SGT_FL_McPherson_strut ( int id )
	{
		super( id );

		name = "Emer Nonus StreetGT front left McPherson strut";
