...
public class Einvagen_GTK_FL_McPherson_strut extends AdjustableSuspension
{
	public Einvagen_GTK_FL_McPherson_strut ( int id )
	{
		super( id );

		name = "Einvagen 110 GTK front left McPherson strut";
