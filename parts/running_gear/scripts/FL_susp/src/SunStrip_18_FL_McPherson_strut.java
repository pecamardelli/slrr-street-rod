...
public class SunStrip_18_FL_McPherson_strut extends AdjustableSuspension
{
	public SunStrip_18_FL_McPherson_strut ( int id )
	{
		super( id );

		name = "Duhen SunStrip 1.8 DVC front left McPherson strut";
