...
public class Baiern_GT_FL_McPherson_strut extends AdjustableSuspension
{
	public Baiern_GT_FL_McPherson_strut ( int id )
	{
		super( id );

		name = "Baiern CoupeSport GT III front left McPherson strut";
