...
public class Einvagen_GTA_FL_McPherson_strut extends AdjustableSuspension
{
	public Einvagen_GTA_FL_McPherson_strut ( int id )
	{
		super( id );

		name = "Einvagen 140 GTA front left McPherson strut";
