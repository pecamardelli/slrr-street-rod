...
public class Focer_WRC_FL_McPherson_strut extends AdjustableSuspension
{
	public Focer_WRC_FL_McPherson_strut ( int id )
	{
		super( id );

		name = "Shimutshibu Focer WRC front left McPherson strut";
