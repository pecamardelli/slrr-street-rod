...
public class WRS_FL_McPherson_strut extends AdjustableSuspension
{
	public WRS_FL_McPherson_strut ( int id )
	{
		super( id );

		name = "Ishima Enula WR SuperTurizmo front left McPherson strut";
