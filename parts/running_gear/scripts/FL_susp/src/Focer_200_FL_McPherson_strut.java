...
public class Focer_200_FL_McPherson_strut extends AdjustableSuspension
{
	public Focer_200_FL_McPherson_strut ( int id )
	{
		super( id );

		name = "Shimutshibu Focer 200 front left McPherson strut";
