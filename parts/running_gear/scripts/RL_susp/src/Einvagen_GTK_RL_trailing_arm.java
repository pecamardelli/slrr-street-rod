...
public class Einvagen_GTK_RL_trailing_arm extends AdjustableSuspension
{
	public Einvagen_GTK_RL_trailing_arm ( int id )
	{
		super( id );

		name = "Einvagen 110 GTK rear left trailing-arm";
