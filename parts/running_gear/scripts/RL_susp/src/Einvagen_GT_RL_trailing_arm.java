...
public class Einvagen_GT_RL_trailing_arm extends AdjustableSuspension
{
	public Einvagen_GT_RL_trailing_arm ( int id )
	{
		super( id );

		name = "Einvagen 110 GT rear left trailing-arm";
