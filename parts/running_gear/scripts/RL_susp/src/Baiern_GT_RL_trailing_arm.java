...
public class Baiern_GT_RL_trailing_arm extends AdjustableSuspension
{
	public Baiern_GT_RL_trailing_arm ( int id )
	{
		super( id );

		name = "Baiern CoupeSport GT III rear left trailing-arm";
