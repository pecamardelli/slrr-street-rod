...
public class SunStrip_22_RL_trailing_arm extends AdjustableSuspension
{
	public SunStrip_22_RL_trailing_arm ( int id )
	{
		super( id );

		name = "Duhen SunStrip 2.2 DVC rear left trailing-arm";
