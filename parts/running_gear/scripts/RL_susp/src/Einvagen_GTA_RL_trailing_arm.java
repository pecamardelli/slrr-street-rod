...
public class Einvagen_GTA_RL_trailing_arm extends AdjustableSuspension
{
	public Einvagen_GTA_RL_trailing_arm ( int id )
	{
		super( id );

		name = "Einvagen 140 GTA rear left trailing-arm";
