...
public class Focer_300_RL_trailing_arm extends AdjustableSuspension
{
	public Focer_300_RL_trailing_arm ( int id )
	{
		super( id );

		name = "Shimutshibu Focer 300 rear left trailing-arm";
