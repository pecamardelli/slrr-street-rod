...
public class Baiern_CS_RL_trailing_arm extends AdjustableSuspension
{
	public Baiern_CS_RL_trailing_arm ( int id )
	{
		super( id );

		name = "Baiern CoupeSport 2.5 rear left trailing-arm";
