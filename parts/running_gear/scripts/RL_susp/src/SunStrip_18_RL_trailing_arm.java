...
public class SunStrip_18_RL_trailing_arm extends AdjustableSuspension
{
	public SunStrip_18_RL_trailing_arm ( int id )
	{
		super( id );

		name = "Duhen SunStrip 1.8 DVC rear left trailing-arm";
