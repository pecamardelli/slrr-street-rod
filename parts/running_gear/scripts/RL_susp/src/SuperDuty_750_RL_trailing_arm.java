...
public class SuperDuty_750_RL_trailing_arm extends AdjustableSuspension
{
	public SuperDuty_750_RL_trailing_arm ( int id )
	{
		super( id );

		name = "Hauler's SuperDuty Extra 750 rear left trailing-arm";
