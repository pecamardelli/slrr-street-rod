...
public class Focer_WRC_RL_trailing_arm extends AdjustableSuspension
{
	public Focer_WRC_RL_trailing_arm ( int id )
	{
		super( id );

		name = "Shimutshibu Focer WRC rear left trailing-arm";
