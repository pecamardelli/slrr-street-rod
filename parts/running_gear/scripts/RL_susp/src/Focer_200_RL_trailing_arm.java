...
public class Focer_200_RL_trailing_arm extends AdjustableSuspension
{
	public Focer_200_RL_trailing_arm ( int id )
	{
		super( id );

		name = "Shimutshibu Focer 200 rear left trailing-arm";
