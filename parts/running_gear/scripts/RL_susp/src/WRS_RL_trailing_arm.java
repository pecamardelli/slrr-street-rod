...
public class WRS_RL_trailing_arm extends AdjustableSuspension
{
	public WRS_RL_trailing_arm ( int id )
	{
		super( id );

		name = "Ishima Enula WR SuperTurizmo rear left trailing-arm";
