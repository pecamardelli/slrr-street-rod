...
public class SunStrip_20_RR_trailing_arm extends AdjustableSuspension
{
	public SunStrip_20_RR_trailing_arm ( int id )
	{
		super( id );

		name = "Duhen Racing SunStrip 2.0 CDVC rear right trailing-arm";
