...
public class SuperDuty_500_RR_trailing_arm extends AdjustableSuspension
{
	public SuperDuty_500_RR_trailing_arm ( int id )
	{
		super( id );

		name = "Hauler's SuperDuty 500 rear right trailing-arm";
