...
public class Nonus_SGT_RR_trailing_arm extends AdjustableSuspension
{
	public Nonus_SGT_RR_trailing_arm ( int id )
	{
		super( id );

		name = "Emer Nonus StreetGT rear right trailing-arm";
