...
public class SunStrip_15_RR_trailing_arm extends AdjustableSuspension
{
	public SunStrip_15_RR_trailing_arm ( int id )
	{
		super( id );

		name = "Duhen SunStrip 1.5 DVC rear right trailing-arm";
