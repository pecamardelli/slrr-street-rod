...
public class WRS_RR_trailing_arm extends AdjustableSuspension
{
	public WRS_RR_trailing_arm ( int id )
	{
		super( id );

		name = "Ishima Enula WR SuperTurizmo rear right trailing-arm";

		value = tHUF2USD(163.0);
