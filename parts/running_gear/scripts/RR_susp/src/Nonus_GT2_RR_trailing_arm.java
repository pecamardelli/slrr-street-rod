...
public class Nonus_GT2_RR_trailing_arm extends AdjustableSuspension
{
	public Nonus_GT2_RR_trailing_arm ( int id )
	{
		super( id );

		name = "Emer Motorsport Nonus GT2 rear right trailing-arm";
