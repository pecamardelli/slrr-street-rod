...
public class Baiern_DS_RR_trailing_arm extends AdjustableSuspension
{
	public Baiern_DS_RR_trailing_arm ( int id )
	{
		super( id );

		name = "Baiern DevilSport rear right trailing-arm";
