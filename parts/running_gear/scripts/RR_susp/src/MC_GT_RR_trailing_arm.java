...
public class MC_GT_RR_trailing_arm extends AdjustableSuspension
{
	public MC_GT_RR_trailing_arm ( int id )
	{
		super( id );

		name = "MC GT rear right trailing-arm";

		value = tHUF2USD(87.3);
		brand_new_prestige_value = 57.0;
