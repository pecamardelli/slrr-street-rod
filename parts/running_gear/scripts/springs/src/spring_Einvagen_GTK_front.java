...
public class spring_Einvagen_GTK_front extends AdjustableSpring
{
	public spring_Einvagen_GTK_front( int id )
	{
		super( id );

		designedMassOnWheel = getMessOnWheel(1309.0, 54.8, WHL_FRONT);
