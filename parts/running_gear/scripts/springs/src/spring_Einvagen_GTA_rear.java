...
public class spring_Einvagen_GTA_rear extends AdjustableSpring
{
	public spring_Einvagen_GTA_rear( int id )
	{
		super( id );

		designedMassOnWheel = getMessOnWheel(1301.0, 55.3, WHL_REAR);
