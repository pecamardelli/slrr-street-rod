...
public class ford_racing_cylinder_head extends OHV_CylinderHead
{
	public ford_racing_cylinder_head( int id )
	{
		super( id );
		name = "Ford racing cylinder head";
		description = "";
		...
		intake_efficiency_tuning = 1.1; // 0.1-2.0
		exhaust_efficiency_tuning = 1.1;// 0.1-2.0
		...
		intake_valve_diam = 45.0;
		number_of_intake_valves_per_cylinder = 1.0;
		exhaust_valve_diam = 42.5;
