...
public class kit_221_SP extends Set
{
	public kit_221_SP( int id )
	{
		super( id );
		name = "Ford 221 Sprint cu.in. engine kit";
		description = "";
	}
	...
	public void build( Inventory inv )
	{
		...
		inv.insertItem( parts.engines.ford_l6:0x00000050r ); // sprint_cylinder_head
		...
		inv.insertItem( parts.engines.ford_l6:0x0000004Ar ); // sprint_intake_manifold
		inv.insertItem( parts.engines.ford_l6:0x0000004Cr ); // sprint_exhaust_header
		inv.insertItem( parts.engines.ford_l6:0x0000004Br ); // carb_holley_2300
