...
public class ford_221_block extends Block_Inline_OHV
{
	public ford_221_block( int id )
	{		
		super( id );
		name = "Ford 221 cu.in. engine block";
		description = "Cast iron block. Displacement: 3.6 liters. Bore: 93.47 mm.";
		...
		cylinder_length_from_top = 179.44;
		crank_center_to_cylinder_top = 214.43;
