...
public class sprint_cylinder_head extends OHV_CylinderHead
{
	public sprint_cylinder_head( int id )
	{
		super( id );
		name = "Sprint cylinder head";
		description = "";
		...
		intake_rocker_ratio = 1.6; // common 1.5 - 1.9
		exhaust_rocker_ratio = 1.6; // common 1.5 - 1.9
