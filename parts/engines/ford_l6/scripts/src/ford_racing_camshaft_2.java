...
public class ford_racing_camshaft_2 extends OHV_Camshaft
{
	public ford_racing_camshaft_2( int id )
	{
		super( id );
		name = "Ford racing mid-rpm camshaft";
		description = "";
		...
		static_input_time_in_duration	= 219.0;
		static_input_time_out_duration	= 209.0;
