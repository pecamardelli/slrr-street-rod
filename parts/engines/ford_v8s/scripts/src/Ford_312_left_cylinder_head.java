...
public class Ford_312_left_cylinder_head extends OHV_CylinderHead
{
	public Ford_312_left_cylinder_head( int id )
	{
		super( id );
		name = "Ford 312 V8 left cylinder head";
		description = "";
