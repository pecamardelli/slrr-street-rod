...
public class Ford_390_4brl_intake_manifold extends IntakeManifold
{
	public Ford_390_4brl_intake_manifold( int id )
	{
		super( id );
		name = "Ford 390 V8 four-barrel intake manifold";
		description = "";
