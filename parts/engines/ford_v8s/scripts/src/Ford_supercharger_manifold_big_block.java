...
public class Ford_supercharger_manifold_big_block extends IntakeManifold
{
	public Ford_supercharger_manifold_big_block( int id )
	{
		super( id );
		name = "Ford V8 supercharger manifold (390-460)";
		description = "";
		brand_new_prestige_value = 95.01;

		value = tHUF2USD(109.535);
