...
public class Ford_312_right_cylinder_head extends OHV_CylinderHead
{
	public Ford_312_right_cylinder_head( int id )
	{
		super( id );
		name = "Ford 312 V8 right cylinder head";
		description = "";
