...
public class Ford_332_right_cylinder_head extends OHV_CylinderHead
{
	public Ford_332_right_cylinder_head( int id )
	{
		super( id );
		name = "Ford 332 V8 right cylinder head";
		description = "";
		brand_new_prestige_value = 48.16;
