...
public class Ford_racing_left_cylinder_head_small_block extends OHV_CylinderHead
{
	public Ford_racing_left_cylinder_head_small_block( int id )
	{
		super( id );
		name = "Ford Racing left cylinder head (260-351)";
		description = "";
