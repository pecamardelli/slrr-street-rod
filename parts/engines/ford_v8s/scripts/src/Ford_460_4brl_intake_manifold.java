...
public class Ford_460_4brl_intake_manifold extends IntakeManifold
{
	public Ford_460_4brl_intake_manifold( int id )
	{
		super( id );
		name = "Ford 460 V8 four-barrel intake manifold";
		description = "";
		brand_new_prestige_value = 75.01;
