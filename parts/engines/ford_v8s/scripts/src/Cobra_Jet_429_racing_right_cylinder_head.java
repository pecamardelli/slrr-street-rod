...
public class Cobra_Jet_429_racing_right_cylinder_head extends OHV_CylinderHead
{
	public Cobra_Jet_429_racing_right_cylinder_head( int id )
	{
		super( id );
		name = "Ford Cobra Jet 429 V8 racing right cylinder head";
		description = "";
