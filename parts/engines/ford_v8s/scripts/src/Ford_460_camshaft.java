...
public class Ford_460_camshaft extends OHV_Camshaft
{
	public Ford_460_camshaft( int id )
	{
		super( id );
		name = "Ford 460 V8 camshaft";
		description = "";
		brand_new_prestige_value = 75.80;
		...
		static_input_lobe_separation	= 227;
