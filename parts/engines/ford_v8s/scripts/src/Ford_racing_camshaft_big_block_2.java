...
public class Ford_racing_camshaft_big_block_2 extends OHV_Camshaft
{
	public Ford_racing_camshaft_big_block_2( int id )
	{
		super( id );
		name = "Ford Racing camshaft high torque (302/312/351/390/429/460)";
		description = "Enhances torque at low RPM level. Good for all displacements!";
		...
		static_input_lobe_separation	= 226.0;
