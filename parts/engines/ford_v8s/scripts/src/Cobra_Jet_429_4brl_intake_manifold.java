...
public class Cobra_Jet_429_4brl_intake_manifold extends IntakeManifold
{
	public Cobra_Jet_429_4brl_intake_manifold( int id )
	{
		super( id );
		name = "Ford Cobra Jet 429 V8 four-barrel intake manifold";
		description = "";
		brand_new_prestige_value = 85.01;
