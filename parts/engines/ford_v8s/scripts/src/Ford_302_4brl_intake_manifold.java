...
public class Ford_302_4brl_intake_manifold extends IntakeManifold
{
	public Ford_302_4brl_intake_manifold( int id )
	{
		super( id );
		name = "Ford 302 V8 four-barrel intake manifold";
		description = "";
		brand_new_prestige_value = 65.01;
