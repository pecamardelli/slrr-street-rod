...
public class Ford_260_4brl_intake_manifold extends IntakeManifold
{
	public Ford_260_4brl_intake_manifold( int id )
	{
		super( id );
		name = "Ford 260 V8 four-barrel intake manifold";
		description = "";
		brand_new_prestige_value = 46.01;
