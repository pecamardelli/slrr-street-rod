...
public class Ford_racing_right_cylinder_head_big_block extends OHV_CylinderHead
{
	public Ford_racing_right_cylinder_head_big_block( int id )
	{
		super( id );
		name = "Ford Racing right cylinder head (390 and 460)";
		description = "";
