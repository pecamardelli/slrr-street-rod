...
public class Ford_racing_camshaft_small_block_3 extends OHV_Camshaft
{
	public Ford_racing_camshaft_small_block_3( int id )
	{
		super( id );
		name = "Ford Racing camshaft medium RPM and torque (260-351)";
