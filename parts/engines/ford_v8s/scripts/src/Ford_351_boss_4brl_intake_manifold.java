...
public class Ford_351_boss_4brl_intake_manifold extends IntakeManifold
{
	public Ford_351_boss_4brl_intake_manifold( int id )
	{
		super( id );
		name = "Ford 351 Boss V8 four-barrel intake manifold";
		description = "";
