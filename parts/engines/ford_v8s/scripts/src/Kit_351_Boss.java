...
public class Kit_351_Boss extends Set
{
	public Kit_351_Boss( int id )
	{
		super( id  ); // 
		name = "Ford Boss 351 V8 engine kit";
		description = "";
	}

	public void build( Inventory inv )
	{		
		inv.insertItem( parts.engines.ford_v8s:0x00005001r ); // "Ford_351_block" // 
		inv.insertItem( parts.engines.ford_v8s:0x000050FEr ); // "Ford_351_crankshaft" // 
		inv.insertItem( parts.engines.ford_v8s:0x000000BBr ); // "Ford_stock_crankshaft_timing_gear" // 
		inv.insertItem( parts.engines.ford_v8s:0x000050A8r ); // "Ford_351_connecting_rods" // 
		inv.insertItem( parts.engines.ford_v8s:0x00005056r ); // "Ford_302_332_351_pistons" // 
		inv.insertItem( parts.engines.ford_v8s:0x00000A51r ); // "Ford_351_camshaft" // 
		...
		inv.insertItem( parts.engines.ford_v8s:0x000030ADr ); // "Ford_351_390_left_cylinder_head" // 
		...
		inv.insertItem( parts.engines.ford_v8s:0x00003BBEr ); // "Ford_351_boss_4brl_intake_manifold" // 
		inv.insertItem( parts.engines.ford_v8s:0x0000008Br ); // "carb_4brl" // 
		inv.insertItem( parts.engines.ford_v8s:0x00003686r ); // "Ford_351_4brl_air_filter" // 
		...
		inv.insertItem( parts.engines.ford_v8s:0x00005899r ); // "Tranny_tremec_t45_5spd" // 
	}
}
