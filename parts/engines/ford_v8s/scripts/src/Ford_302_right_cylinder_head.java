...
public class Ford_302_right_cylinder_head extends OHV_CylinderHead
{
	public Ford_302_right_cylinder_head( int id )
	{
		super( id );
		name = "Ford 302 V8 right cylinder head";
		description = "";
		brand_new_prestige_value = 43.16;
		...
		intake_valve_diam = 45.03;
		number_of_intake_valves_per_cylinder = 1.0;
		exhaust_valve_diam = 36.6;
