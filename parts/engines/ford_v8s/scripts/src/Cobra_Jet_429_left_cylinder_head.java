...
public class Cobra_Jet_429_left_cylinder_head extends OHV_CylinderHead
{
	public Cobra_Jet_429_left_cylinder_head( int id )
	{
		super( id );
		name = "Ford Cobra Jet 429 V8 left cylinder head";
		description = "";
