...
public class Ford_racing_right_cylinder_head_small_block extends OHV_CylinderHead
{
	public Ford_racing_right_cylinder_head_small_block( int id )
	{
		super( id );
		name = "Ford Racing right cylinder head (260-351)";
		description = "";
		brand_new_prestige_value = 93.16;

		value = tHUF2USD(197.559);
	...
	public String isDynoable()
	{
		...
		p = partOnSlot( 23 );
		if (!p)
			return "the engine is missing the right cylinder head cover.";
