...
public class Ford_312_4brl_intake_manifold extends IntakeManifold
{
	public Ford_312_4brl_intake_manifold( int id )
	{
		super( id );
		name = "Ford 312 V8 four-barrel intake manifold";
		description = "";
