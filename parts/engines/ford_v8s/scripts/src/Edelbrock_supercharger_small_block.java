...
public class Edelbrock_supercharger_small_block extends SuperCharger
{
	public Edelbrock_supercharger_small_block( int id )
	{
		super( id );
		name = "Edelbrock 7.0 psi roots type supercharger (260/292/332)";
		description = "";
