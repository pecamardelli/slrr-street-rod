...
public class Ford_racing_camshaft_small_block_1 extends OHV_Camshaft
{
	public Ford_racing_camshaft_small_block_1( int id )
	{
		super( id );
		name = "Ford Racing camshaft RPM Boost (260-351)";
		description = "Best performance on 302 and 351 blocks. Be aware of RPM limit on your engine!!";
