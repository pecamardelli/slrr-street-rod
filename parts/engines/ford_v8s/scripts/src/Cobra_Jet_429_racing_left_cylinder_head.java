...
public class Cobra_Jet_429_racing_left_cylinder_head extends OHV_CylinderHead
{
	public Cobra_Jet_429_racing_left_cylinder_head( int id )
	{
		super( id );
		name = "Ford Cobra Jet 429 V8 Racing left cylinder head";
		description = "";
		brand_new_prestige_value = 83.16;
		...
		intake_valve_diam = 58.5;
		number_of_intake_valves_per_cylinder = 1.0;
		exhaust_valve_diam = 46.3;
