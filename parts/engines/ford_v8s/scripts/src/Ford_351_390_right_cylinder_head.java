...
public class Ford_351_390_right_cylinder_head extends OHV_CylinderHead
{
	public Ford_351_390_right_cylinder_head( int id )
	{
		super( id );
		name = "Ford 351/390 V8 right cylinder head";
		description = "";
