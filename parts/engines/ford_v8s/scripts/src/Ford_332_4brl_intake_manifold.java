...
public class Ford_332_4brl_intake_manifold extends IntakeManifold
{
	public Ford_332_4brl_intake_manifold( int id )
	{
		super( id );
		name = "Ford 332 V8 four-barrel intake manifold";
		description = "";
		brand_new_prestige_value = 69.01;
