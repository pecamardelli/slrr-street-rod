...
public class Ford_351_390_left_cylinder_head extends OHV_CylinderHead
{
	public Ford_351_390_left_cylinder_head( int id )
	{
		super( id );
		name = "Ford 351/390 V8 left cylinder head";
		description = "";
