...
public class Edelbrock_4brl_carburetor extends FuelInjectorSystem
{
	public Edelbrock_4brl_carburetor( int id )
	{
		super( id );
		name = "Edelbrock Performer series 500 CFM four-barrel carburetor";
		description = "";
