...
public class Holley_4brl_intake_manifold_small_block extends IntakeManifold
{
	public Holley_4brl_intake_manifold_small_block( int id )
	{
		super( id );
		name = "Holley street Dominator four-barrel intake manifold (260/292/312)";
		description = "";
		brand_new_prestige_value = 79.01;

		value = tHUF2USD(95.535);
