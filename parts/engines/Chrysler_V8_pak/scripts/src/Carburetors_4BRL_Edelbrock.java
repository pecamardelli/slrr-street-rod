...
public class Carburetors_4BRL_Edelbrock extends FuelInjectorSystem
{
	public Carburetors_4BRL_Edelbrock( int id )
	{
		super( id );
		name = "Edelbrock 4BRL Carburetors";
		description = "";
		brand_new_prestige_value = 50.50;

		value = tHUF2USD(227.35);
