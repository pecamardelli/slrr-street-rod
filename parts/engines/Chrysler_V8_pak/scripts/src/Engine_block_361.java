...
public class Engine_block_361 extends Block_Vee_OHV
{
	public Engine_block_361( int id )
	{
		super( id );
		name = "Chrysler B 361 V8 engine Block 1958-1966";
		description = "";

		brand_new_prestige_value = 80.05;
		value = tHUF2USD(168.0);
