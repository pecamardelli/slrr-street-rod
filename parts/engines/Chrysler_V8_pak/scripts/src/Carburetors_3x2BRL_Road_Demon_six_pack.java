...
public class Carburetors_3x2BRL_Road_Demon_six_pack extends FuelInjectorSystem
{
	public Carburetors_3x2BRL_Road_Demon_six_pack( int id )
	{
		super( id );
		name = "Road Demon Six Pack 3x2BRL Carburetors";
		description = "";
		brand_new_prestige_value = 95.95;

		value = tHUF2USD(388.55);
