...
public class Carburetors_2x4BRL_Crassram_Edelbrock extends FuelInjectorSystem
{
	public Carburetors_2x4BRL_Crassram_Edelbrock( int id )
	{
		super( id );
		name = "Edelbrock Crassram 2x4BRL Carburetors";
		description = "";
		brand_new_prestige_value = 125.55;

		value = tHUF2USD(474.75);
