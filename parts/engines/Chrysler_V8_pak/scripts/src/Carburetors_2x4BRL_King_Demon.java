...
public class Carburetors_2x4BRL_King_Demon extends FuelInjectorSystem
{
	public Carburetors_2x4BRL_King_Demon( int id )
	{
		super( id );
		name = "King Demon 2x4BRL Carburetors";
		description = "";
		brand_new_prestige_value = 115.95;

		value = tHUF2USD(595.75);
