...
public class Carburetors_2x4BRL_Edelbrock extends FuelInjectorSystem
{
	public Carburetors_2x4BRL_Edelbrock( int id )
	{
		super( id );
		name = "Edelbrock 2x4BRL Carburetors";
		description = "";
		brand_new_prestige_value = 95.95;

		value = tHUF2USD(454.75);
