...
public class Engine_block_340 extends Block_Vee_OHV
{
	public Engine_block_340( int id )
	{
		super( id );
		name = "Chrysler LA 340 engine Block 1968-1973";
		description = "";

		brand_new_prestige_value = 60.65;
		value = tHUF2USD(150.65);
