...
public class Carburetors_2x4BRL_Dominator_HOLLEY extends FuelInjectorSystem
{
	public Carburetors_2x4BRL_Dominator_HOLLEY( int id )
	{
		super( id );
		name = "HOLLEY Dominator 2x4BRL Carburetors";
		description = "";
		brand_new_prestige_value = 90.90;

		value = tHUF2USD(411.55);
