...
public class Roc
{
	...
	{
		return "maps\\roc_track\\race.spl";
	...
	{
		VehicleDescriptor vd = GameLogic.getVehicleDescriptor( VehicleType.VS_RRACE );
		return new Vehicle( getNextOpponent(), vd.id, vd.colorIndex, vd.optical, vd.power, vd.wear, vd.tear );
	}
