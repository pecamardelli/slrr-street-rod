...
abstract public class Scene extends GameType
{
	...
	public void addSceneElements( int config )
	{
		if( config != lastConfig )
		{
			...
			if( config == 0 )	//ejjel 22-3
			{
				if( !internalScene )
				{
					if( Config.mapFog == 1 ) map.setFog( 0x0007121e, 20.0, clampTo( Config.cameras_viewrange/8, 30.0 ) );
			...
			if ( config == 1 )	//reggel 3-4 v1
			{
				if( !internalScene )
				{
					if( Config.mapFog == 1 ) map.setFog( 0x00171516, 50.0, clampTo( Config.cameras_viewrange/8, 40.0 ) );
			...
			if ( config == 2 )	//reggel 3-4 v2
			{
				if( !internalScene )
				{
					if( Config.mapFog == 1 ) map.setFog( 0x00111113, 10.0, clampTo( Config.cameras_viewrange/8, 32.0 ) );
			...
			if ( config == 3 )		//reggel 4-8 v1
			{
				if( !internalScene )
				{
					if( Config.mapFog == 1 ) map.setFog( 0x0031364B, 50.0, clampTo( Config.cameras_viewrange/8, 40.0 ) );
			...
			if ( config == 4 )		//reggel 4-8 v2
			{
				if( !internalScene )
				{
					if( Config.mapFog == 1 ) map.setFog( 0x00696063, 30.0, clampTo( Config.cameras_viewrange/8, 40.0 ) );
			...
			if ( config == 5 )		//reggel 4-8 v3
			{
				if( !internalScene )
				{
					if( Config.mapFog == 1 ) map.setFog( 0x00080808, 50.0, clampTo( Config.cameras_viewrange/8, 40.0 ) );
			...
			if ( config == 6 )		//napkozben 8-10
			{
				if( !internalScene )
				{
					if( Config.mapFog == 1 ) map.setFog( 0x00B0BCBC, 70.0, clampTo( Config.cameras_viewrange/8, 80.0 ) );
			...
			if ( config == 7 )		//napkozben 10-19 v1
			{
				if( !internalScene )
				{
					if( Config.mapFog == 1 ) map.setFog( 0x005E7992, 70.0, clampTo( Config.cameras_viewrange/8, 80.0 ) );
			...
			if ( config == 8 )		//napkozben 10-19 v2
			{
				if( !internalScene )
				{
					if( Config.mapFog == 1 ) map.setFog( 0x00A1B5C3, 70.0, clampTo( Config.cameras_viewrange/8, 80.0 ) );
			...
			if ( config == 9 )		//napkozben 10-19 v3
			{
				if( !internalScene )
				{
					if( Config.mapFog == 1 ) map.setFog( 0x00869BAD, 70.0, clampTo( Config.cameras_viewrange/8, 80.0 ) );
			...
			if ( config == 10 )		//napkozben 10-19 v4
			{
				if( !internalScene )
				{
					if( Config.mapFog == 1 ) map.setFog( 0x00A4A1A0, 70.0, clampTo( Config.cameras_viewrange/8, 80.0 ) );
			...
			if ( config == 11 )		//delutan 19-20:30
			{
				if( !internalScene )
				{
					if( Config.mapFog == 1 ) map.setFog( 0x003B4858, 60.0, clampTo( Config.cameras_viewrange/8, 60.0 ) );
			...
			if ( config == 12 )		//este 20:30-22 v1
			{
				if( !internalScene )
				{
					if( Config.mapFog == 1 ) map.setFog( 0x00160702, 60.0, clampTo( Config.cameras_viewrange/8, 60.0 ) );
			...
			if ( config == 13 )		//este 20:30-22 v2
			{
				if( !internalScene )
				{
					if( Config.mapFog == 1 ) map.setFog( 0x00000000, 60.0, clampTo( Config.cameras_viewrange/8, 60.0 ) );
			...
			if ( config == 14 )		//este 20:30-22 v3
			{
				if( !internalScene )
				{
					if( Config.mapFog == 1 ) map.setFog( 0x00030305, 60.0, clampTo( Config.cameras_viewrange/8, 60.0 ) );
	...
	public float clampTo( float val, float min )
	{
