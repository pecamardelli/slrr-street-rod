...
public class El_Camino_70 extends El_Camino_models
{
	...
	public void addStockParts( Descriptor desc )
	{
		...
		stock_parts_list_FL[ 1] = cars.racers.Chevrolet_El_Camino_1970:0x000000B9r; // "FL quarterpanel" //

		stock_parts_list_FR = new int[2];
		stock_parts_list_FR[ 0] = cars.racers.Chevrolet_El_Camino_1970:0x000000BCr; // "R headlights" //
		stock_parts_list_FR[ 1] = cars.racers.Chevrolet_El_Camino_1970:0x000000C4r; // "FR quarterpanel" //

		stock_parts_list_RL = new int[2];
		stock_parts_list_RL[ 0] = cars.racers.Chevrolet_El_Camino_1970:0x000000ACr; // "L taillights" //

		stock_parts_list_RR = new int[2];
		stock_parts_list_RR[ 0] = cars.racers.Chevrolet_El_Camino_1970:0x000000BDr; // "R taillights" //

		stock_parts_list_F  = new int[6];
		stock_parts_list_F[ 0] = cars.racers.Chevrolet_El_Camino_1970:0x000000A7r; // "F bumper" //
		stock_parts_list_F[ 4] = cars.racers.Chevrolet_El_Camino_1970:0x000000B6r; // "hood" //
		stock_parts_list_F[ 5] = cars.racers.Chevrolet_El_Camino_1970:0x000000B0r; // "F windshield" //

		stock_parts_list_Rr = new int[4];
		stock_parts_list_Rr[ 0] = cars.racers.Chevrolet_El_Camino_1970:0x000000AAr; // "R bumper" //
		stock_parts_list_Rr[ 1] = cars.racers.Chevrolet_El_Camino_1970:0x000000ADr; // "trunk" //
		stock_parts_list_Rr[ 2] = cars.racers.Chevrolet_El_Camino_1970:0x000000B1r; // "R windshield" //
		stock_parts_list_Rr[ 3] = cars.racers.Chevrolet_El_Camino_1970:0x000000ABr; // "Logo" //

		stock_parts_list_L  = new int[4];
		stock_parts_list_L[ 0] = cars.racers.Chevrolet_El_Camino_1970:0x000000AEr; // "FL door" //
		stock_parts_list_L[ 1] = cars.racers.Chevrolet_El_Camino_1970:0x000000B2r; // "FL seat" //
		stock_parts_list_L[ 2] = cars.racers.Chevrolet_El_Camino_1970:0x000000C1r; // "L_mirror" //
		stock_parts_list_L[ 3] = cars.racers.Chevrolet_El_Camino_1970:0x000000AFr; // "FL_window" //

		stock_parts_list_R  = new int[4];
		stock_parts_list_R[ 0] = cars.racers.Chevrolet_El_Camino_1970:0x000000C2r; // "FR door" //
		stock_parts_list_R[ 1] = cars.racers.Chevrolet_El_Camino_1970:0x000000BFr; // "FR seat" //
		stock_parts_list_R[ 2] = cars.racers.Chevrolet_El_Camino_1970:0x000000C5r; // "R_mirror" //
		stock_parts_list_R[ 3] = cars.racers.Chevrolet_El_Camino_1970:0x000000BEr; // "FR_window" //
	...
	// running gear parts lists //
		...
		addPart( cars.racers.Chevrolet_El_Camino_1970:0x000000B3r, "steering wheel" );

		addPart( cars.racers.Chevrolet_El_Camino_1970:0x00000129r, "stock_L_exhaust_pipe" );
		addPart( cars.racers.Chevrolet_El_Camino_1970:0x0000012Ar, "stock_R_exhaust_pipe" );
