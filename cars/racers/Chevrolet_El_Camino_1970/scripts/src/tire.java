...
public class tire extends Tyre
{
	public tire ( int id )
	{
		...
		render_types[12] = cars.racers.Chevrolet_El_Camino_1970:0x00001460r;	// for 11.0 inch wide rims //
		...
		render_types[21] = cars.racers.Chevrolet_El_Camino_1970:0x00001460r;	// this rendertype as default //
