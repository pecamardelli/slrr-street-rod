...
public class Ford_Deluxe_40 extends Ford_Deluxe_40_models
{
	public Ford_Deluxe_40( int id )
	{
		...
		vehicleName = "Ford De Luxe Coupe '40";
		name = "Ford De Luxe Coupe '40 chassis";
	...
	public void addStockParts( Descriptor desc )
	{
		...
		stock_parts_list_FL[ 0] = cars.racers.FOR_Coupe_40:0x00000111r; // "L headlights" //
		stock_parts_list_FL[ 1] = cars.racers.FOR_Coupe_40:0x00000110r; // "FL quarterpanel" //

		stock_parts_list_FR = new int[2];
		stock_parts_list_FR[ 0] = cars.racers.FOR_Coupe_40:0x00000117r; // "R headlights" //
		stock_parts_list_FR[ 1] = cars.racers.FOR_Coupe_40:0x00000116r; // "FR quarterpanel" //

		stock_parts_list_RL = new int[2];
		stock_parts_list_RL[ 0] = cars.racers.FOR_Coupe_40:0x00000108r; // "L taillights" //
		stock_parts_list_RL[ 1] = cars.racers.FOR_Coupe_40:0x00000109r; // "RL quarterpanel" //

		stock_parts_list_RR = new int[2];
		stock_parts_list_RR[ 0] = cars.racers.FOR_Coupe_40:0x00000114r; // "R taillights" //
		stock_parts_list_RR[ 1] = cars.racers.FOR_Coupe_40:0x00000119r; // "RR quarterpanel" //

		stock_parts_list_F  = new int[3];
		stock_parts_list_F[ 0] = cars.racers.FOR_Coupe_40:0x0000010Fr; // "F bumper" //
		stock_parts_list_F[ 1] = cars.racers.FOR_Coupe_40:0x0000010Dr; // "hood" //
		stock_parts_list_F[ 2] = cars.racers.FOR_Coupe_40:0x0000010Br; // "F windshield" //

		stock_parts_list_Rr = new int[3];
		stock_parts_list_Rr[ 0] = cars.racers.FOR_Coupe_40:0x00000107r; // "R bumper" //
		stock_parts_list_Rr[ 1] = cars.racers.FOR_Coupe_40:0x00000118r; // "trunk" //
		stock_parts_list_Rr[ 2] = cars.racers.FOR_Coupe_40:0x00000102r; // "R windshield" //

		stock_parts_list_L  = new int[6];
		stock_parts_list_L[ 0] = cars.racers.FOR_Coupe_40:0x0000011Er; // "L sideskirt" //
		stock_parts_list_L[ 1] = cars.racers.FOR_Coupe_40:0x00000115r; // "FL door" //
		stock_parts_list_L[ 2] = cars.racers.FOR_Coupe_40:0x00000104r; // "L mirror" //
		stock_parts_list_L[ 3] = cars.racers.FOR_Coupe_40:0x0000010Er; // "FL window" //
		stock_parts_list_L[ 4] = cars.racers.FOR_Coupe_40:0x0000010Ar; // "RL window" //
		stock_parts_list_L[ 5] = cars.racers.FOR_Coupe_40:0x00000103r; // "FL seat" //

		stock_parts_list_R  = new int[6];
		stock_parts_list_R[ 0] = cars.racers.FOR_Coupe_40:0x00000126r; // "R sideskirt" //
		stock_parts_list_R[ 1] = cars.racers.FOR_Coupe_40:0x00000128r; // "FR door" //
		stock_parts_list_R[ 2] = cars.racers.FOR_Coupe_40:0x0000011Ar; // "R mirror" //
		stock_parts_list_R[ 3] = cars.racers.FOR_Coupe_40:0x00000112r; // "FR window" //
		stock_parts_list_R[ 4] = cars.racers.FOR_Coupe_40:0x0000010Cr; // "RR window" //
		stock_parts_list_R[ 5] = cars.racers.FOR_Coupe_40:0x00000113r; // "FR seat" //
...
//		stock_parts_list_RGear_sways[ 1] = parts:0x0000021Ar; // "Baiern_CS_rear" //
		...
		addPart( cars.racers.FOR_Coupe_40:0x00000105r, "steering wheel" );

		addPart( cars.racers.FOR_Coupe_40:0x00000182r, "stock_exhaust_pipe" );
