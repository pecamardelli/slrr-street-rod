...
public class stock_tyre extends Tyre
{
	public stock_tyre  ( int id )
	{
		...
		render_types[4]  = cars.racers.FOR_Coupe_40:0x00002029r;	// for  7.0 inch wide rims //
		render_types[5]  = cars.racers.FOR_Coupe_40:0x00002029r;	// for  7.5 inch wide rims //h
		render_types[6]  = cars.racers.FOR_Coupe_40:0x00002029r;	// for  8.0 inch wide rims //
		render_types[7]  = cars.racers.FOR_Coupe_40:0x00002029r;	// for  8.5 inch wide rims //
		render_types[8]  = cars.racers.FOR_Coupe_40:0x00002029r;	// for  9.0 inch wide rims //
		render_types[9]  = cars.racers.FOR_Coupe_40:0x00002029r;	// for  9.5 inch wide rims //
		render_types[10] = cars.racers.FOR_Coupe_40:0x00002029r;	// for 10.0 inch wide rims //
		render_types[11] = cars.racers.FOR_Coupe_40:0x00002029r;	// for 10.5 inch wide rims //
		render_types[12] = cars.racers.FOR_Coupe_40:0x00002029r;	// for 11.0 inch wide rims //
		...
		render_types[21] = cars.racers.FOR_Coupe_40:0x00002029r;	// this rendertype as default //
