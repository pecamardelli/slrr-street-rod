...
public class Chevrolet_Chevelle_70 extends Chevelle_models
{
	...
	public void addStockParts( Descriptor desc )
	{
		...
		stock_parts_list_FL[ 0] = cars.racers.Chevrolet_Chevelle:0x000000A8r; // "L headlights" //
		stock_parts_list_FL[ 1] = cars.racers.Chevrolet_Chevelle:0x000000B9r; // "FL quarterpanel" //
		stock_parts_list_FL[ 2] = cars.racers.Chevrolet_Chevelle:0x0000AA01r; // "Inset FL quarterpanel" //

		stock_parts_list_FR = new int[3];
		stock_parts_list_FR[ 0] = cars.racers.Chevrolet_Chevelle:0x000000BCr; // "R headlights" //
		stock_parts_list_FR[ 1] = cars.racers.Chevrolet_Chevelle:0x000000C4r; // "FR quarterpanel" //
		stock_parts_list_FR[ 2] = cars.racers.Chevrolet_Chevelle:0x0000AA02r; // "Inset FR quarterpanel" //

		stock_parts_list_RL = new int[2];
		stock_parts_list_RL[ 0] = cars.racers.Chevrolet_Chevelle:0x000000ACr; // "L taillights" //
		stock_parts_list_RL[ 1] = cars.racers.Chevrolet_Chevelle:0x0000AA09r; // "RL window" //

		stock_parts_list_RR = new int[2];
		stock_parts_list_RR[ 0] = cars.racers.Chevrolet_Chevelle:0x000000BDr; // "R taillights" //
		stock_parts_list_RR[ 1] = cars.racers.Chevrolet_Chevelle:0x0000AA08r; // "RR window" //

		stock_parts_list_F  = new int[14];
		stock_parts_list_F[ 0] = cars.racers.Chevrolet_Chevelle:0x000000A7r; // "F bumper" //
		stock_parts_list_F[ 1] = cars.racers.Chevrolet_Chevelle:0x000000B8r; // "F grill frame A" //
		stock_parts_list_F[ 2] = cars.racers.Chevrolet_Chevelle:0x000000BAr; // "F grill frame B" //
		stock_parts_list_F[ 3] = cars.racers.Chevrolet_Chevelle:0x000000B7r; // "F grill" //
		stock_parts_list_F[ 4] = cars.racers.Chevrolet_Chevelle:0x000000B6r; // "hood" //
		stock_parts_list_F[ 5] = cars.racers.Chevrolet_Chevelle:0x000000B0r; // "F windshield" //
		stock_parts_list_F[ 6] = cars.racers.Chevrolet_Chevelle:0x000000BCr; // "R headlights" //
		stock_parts_list_F[ 7] = cars.racers.Chevrolet_Chevelle:0x000000BCr; // "R headlights" //
		stock_parts_list_F[ 8] = cars.racers.Chevrolet_Chevelle:0x000000A8r; // "L headlights" //
		stock_parts_list_F[ 9] = cars.racers.Chevrolet_Chevelle:0x000000A8r; // "L headlights" //
		stock_parts_list_F[ 10] = cars.racers.Chevrolet_Chevelle:0x0000AA18r; // "Castle" //
		stock_parts_list_F[ 11] = cars.racers.Chevrolet_Chevelle:0x0000AA05r; // "L Tumanky" //
		stock_parts_list_F[ 12] = cars.racers.Chevrolet_Chevelle:0x0000AA06r; // "R Tumanky" //
		stock_parts_list_F[ 13] = cars.racers.Chevrolet_Chevelle:0x0000AA07r; // "Air Intake on the Hood" //

		stock_parts_list_Rr = new int[5];
		stock_parts_list_Rr[ 0] = cars.racers.Chevrolet_Chevelle:0x000000AAr; // "R bumper" //
		stock_parts_list_Rr[ 1] = cars.racers.Chevrolet_Chevelle:0x000000ADr; // "trunk" //
		stock_parts_list_Rr[ 2] = cars.racers.Chevrolet_Chevelle:0x000000B1r; // "R windshield" //
		stock_parts_list_Rr[ 3] = cars.racers.Chevrolet_Chevelle:0x000000ACr; // "L taillights" //
		stock_parts_list_Rr[ 4] = cars.racers.Chevrolet_Chevelle:0x000000BDr; // "R taillights" //

		stock_parts_list_L  = new int[2];
		stock_parts_list_L[ 0] = cars.racers.Chevrolet_Chevelle:0x000000AEr; // "FL door" //
		stock_parts_list_L[ 1] = cars.racers.Chevrolet_Chevelle:0x000000B2r; // "FL seat" //

		stock_parts_list_R  = new int[2];
		stock_parts_list_R[ 0] = cars.racers.Chevrolet_Chevelle:0x000000C2r; // "FR door" //
		//stock_parts_list_R[ 1] = cars.racers.Chevrolet_Chevelle:0x000000BFr; // "FR seat" //
	...
	// running gear parts lists //
		...
		addPart( cars.racers.Chevrolet_Chevelle:0x000000B3r, "steering wheel" );

		addPart( cars.racers.Chevrolet_Chevelle:0x00000129r, "stock_L_exhaust_pipe" );
		addPart( cars.racers.Chevrolet_Chevelle:0x0000012Ar, "stock_R_exhaust_pipe" );
