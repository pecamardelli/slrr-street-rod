...
public class Mercury_Park_Lane_White_64 extends Mercury_Park_Lane_64_models
{
	public Mercury_Park_Lane_White_64( int id )
	{
		super( id );
		carCategory = PACKAGE;

		makerName = "Mercury Division";
		model = MODEL_PARK_LANE_WHITE_64;
		vehicleName = "Mercury Park Lane White Top '64";
