...
public class Mercury_Park_Lane_Vinyl_64 extends Mercury_Park_Lane_64_models
{
	public Mercury_Park_Lane_Vinyl_64( int id )
	{
		super( id );
		carCategory = PACKAGE;

		makerName = "Mercury Division";
		model = MODEL_PARK_LANE_VINYL_64;
		vehicleName = "Mercury Park Lane Vinyl Top '64";
		...
		value = tHUF2USD(500.978);
		brand_new_prestige_value = 32.0;
	...
	public void addStockParts( Descriptor desc )
	{
		...
		stock_parts_list_R[ 7] = cars.racers.duhen:0x000020C5r; // "Right wheel bay cover" //
		...
		stock_parts_list_R[ 18] = cars.racers.duhen:0x000010C4r; // "Antenna" //
