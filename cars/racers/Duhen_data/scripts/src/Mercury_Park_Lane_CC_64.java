...
public class Mercury_Park_Lane_CC_64 extends Mercury_Park_Lane_64_models
{
	public Mercury_Park_Lane_CC_64( int id )
	{
		super( id );
		carCategory = PACKAGE;

		makerName = "Mercury Division";
		model = MODEL_PARK_LANE_CC_64;
		vehicleName = "Mercury Park Lane Custom Coupe '64";
	...
	{		
		...
		stock_parts_list_FL[ 0] = cars.racers.duhen:0x00000137r; // "L headlights 2" //
		stock_parts_list_FL[ 1] = cars.racers.duhen:0x000000DEr; // "FL quarterpanel 2" //

		stock_parts_list_FR = new int[2];
		stock_parts_list_FR[ 0] = cars.racers.duhen:0x0000013Ar; // "R headlights 2" //
		stock_parts_list_FR[ 1] = cars.racers.duhen:0x000000E0r; // "FR quarterpanel 2" //

		stock_parts_list_RL = new int[3];
		stock_parts_list_RL[ 0] = cars.racers.duhen:0x000000DBr; // "Rear panel" //
		stock_parts_list_RL[ 1] = cars.racers.duhen:0x000000C9r; // "L taillights" //
		//stock_parts_list_RL[ 2] = cars.racers.duhen:0x000000C7r; // "RL quarterpanel" //
		...
		stock_parts_list_F[ 4] = cars.racers.duhen:0x00000137r; // "R headlights" //
		stock_parts_list_F[ 5] = cars.racers.duhen:0x0000013Ar; // "L headlights" //
...
//		stock_parts_list_RGear_sways[ 1] = parts:0x00000184r; // "swaybar_SunStrip_20_rear" //
		...
		stock_parts_list_RGear_wheels[ 0] = stock_parts_list_RGear_wheels[ 1] = cars.racers.Bosstang:0x00000AD5r; // "rim" //
		stock_parts_list_RGear_wheels[ 2] = stock_parts_list_RGear_wheels[ 3] = cars.racers.Bosstang:0x00000AD5r; // "rim" //

		stock_parts_list_RGear_tyres = new int[4];
		stock_parts_list_RGear_tyres[ 0] = stock_parts_list_RGear_tyres[ 1] = cars.racers.Bosstang:0x000001B3r; // "tire" //
		stock_parts_list_RGear_tyres[ 2] = stock_parts_list_RGear_tyres[ 3] = cars.racers.Bosstang:0x000001B3r; // "tire" //
