...
public class Chevrolet_Camaro_SS_Vinyl_68 extends Chevrolet_Camaro_68_models
{
	public Chevrolet_Camaro_SS_Vinyl_68( int id )
	{
		super( id );
		carCategory = PACKAGE;

		makerName = "General Motors Company";
		model = CHEVY_CAMARO_SS_VINYL_68;
		vehicleName = "Chevrolet Camaro SS Vinyl Top '68";
