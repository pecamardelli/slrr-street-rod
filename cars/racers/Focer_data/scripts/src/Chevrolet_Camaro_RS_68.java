...
public class Chevrolet_Camaro_RS_68 extends Chevrolet_Camaro_68_models
{
	public Chevrolet_Camaro_RS_68( int id )
	{
		super( id );
		carCategory = PACKAGE;

		makerName = "General Motors Company";
		model = CHEVY_CAMARO_RS_68;
		vehicleName = "Chevrolet Camaro RS '68";
