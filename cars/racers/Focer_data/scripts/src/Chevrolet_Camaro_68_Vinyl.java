...
public class Chevrolet_Camaro_68_Vinyl extends Chevrolet_Camaro_68_models
{
	public Chevrolet_Camaro_68_Vinyl( int id )
	{
		super( id );
		carCategory = PACKAGE;

		makerName = "General Motors Company";
		model = CHEVY_CAMARO_VINYL_68;
		vehicleName = "Chevrolet Camaro Vinyl Top '68";
		name = "Chevrolet Camaro Vinyl Top '68 chassis";
	...
	public void addStockParts( Descriptor desc )
	{
		...
		{
			stock_parts_list_F[ 1] = cars.racers.focer:0x000010A4r; // "Stock RS hood (w black strip)" //
		}
		...
		stock_parts_list_R[ 6] = cars.racers.focer:0x000010AEr; // "Stock left mud guard" //
		stock_parts_list_R[ 7] = cars.racers.focer:0x000010B8r; // "Stock right mud guard" //
		stock_parts_list_R[ 8] = cars.racers.focer:0x000000AEr; // "Stock front left fender" //
		stock_parts_list_R[ 9] = cars.racers.focer:0x000000B8r; // "Stock front right fender" //
		stock_parts_list_R[ 10] = cars.racers.focer:0x000020AFr; // "Stock grille bay upper panel" //
		stock_parts_list_R[ 11] = cars.racers.focer:0x000050AFr; // "Stock front grille" //
		stock_parts_list_R[ 12] = cars.racers.focer:0x000030AFr; // "SS front lower valance panel" //
		stock_parts_list_R[ 13] = cars.racers.focer:0x000040AFr; // "Stock front grille filler" //
		stock_parts_list_R[ 14] = cars.racers.focer:0x000010AFr; // "Stock front under-windshield panel" //
		stock_parts_list_R[ 15] = cars.racers.focer:0x000000AFr; // "Stock front bumper" //
		stock_parts_list_R[ 16] = cars.racers.focer:0x000011AFr; // "Stock front heater air fins" //
		stock_parts_list_R[ 17] = cars.racers.focer:0x000000C1r; // "Stock wipers" //
		stock_parts_list_R[ 18] = cars.racers.focer:0x000010BFr; // "Stock rear view mirror" //
		stock_parts_list_R[ 19] = cars.racers.focer:0x000010C1r; // "Stock console" //
		stock_parts_list_R[ 20] = cars.racers.focer:0x000020C1r; // "Stock shifter" //
		stock_parts_list_R[ 21] = cars.racers.focer:0x000010BDr; // "Stock roof carpeting" //
		stock_parts_list_R[ 22] = cars.racers.focer:0x000030BDr; // "Stock left side carpeting" //
		stock_parts_list_R[ 23] = cars.racers.focer:0x000040BDr; // "Stock right side carpeting" //
		stock_parts_list_R[ 24] = cars.racers.focer:0x000050BDr; // "Stock rear carpeting" //
		stock_parts_list_R[ 25] = cars.racers.focer:0x000060BDr; // "Stock trunk carpeting" //
		stock_parts_list_R[ 26] = cars.racers.focer:0x000021AFr; // "Front upper camaro emblem" //
		stock_parts_list_R[ 27] = cars.racers.focer:0x0000A119r; // "Aftermarket valance foglight //
		stock_parts_list_R[ 28] = cars.racers.focer:0x0000A119r; // "Aftermarket valance foglight" //
		stock_parts_list_R[ 29] = cars.racers.focer:0x000020BDr; // "Stock floor carpeting" //
		stock_parts_list_R[ 30] = cars.racers.focer:0x000010B3r; // "Stock rear panel" //
		stock_parts_list_R[ 31] = cars.racers.focer:0x000000A5r; // "Stock left taillights" //
		stock_parts_list_R[ 32] = cars.racers.focer:0x000000BBr; // "Stock right taillights" //
		stock_parts_list_R[ 33] = cars.racers.focer:0x00002AB3r; // "Bow-Tie fuel cup" //
		stock_parts_list_R[ 34] = cars.racers.focer:0x000000AAr; // "Stock front seat" //
